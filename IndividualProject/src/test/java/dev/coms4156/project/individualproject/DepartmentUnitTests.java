...
class DepartmentUnitTests {
    ...
    @Test
    void initialDepartmentState_testPositivePath() {
    ...
    @Test
    void addPersonToMajor_testPositivePath() {
    ...
    @Test
    void dropPersonFromMajor_testPositivePath() {
    ...
    @Test
    void dropPersonFromMajor_testWhenThereAreZeroPeopleMajoringInThisDepartment() {
    ...
    @Test
    void addCourse_testPositivePath() {
        // Test adding a new course to the department
        Course coms3261 = new Course(
                "Josh Alman",
                "417 IAB",
                "2:40-3:55",
                150
    ...
    @Test
    void createCourse_testPositivePath() {
    ...
    @Test
    void toString_testPositivePath() {
